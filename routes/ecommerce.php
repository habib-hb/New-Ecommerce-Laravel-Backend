...
use App\Http\Controllers\ecommerce\EcommerceUsersController;
...
Route::post('user-register', [EcommerceUsersController::class, 'user_register']);

Route::post('user-login', [EcommerceUsersController::class, 'user_login']);

Route::get('read-user-cookie', [EcommerceUsersController::class, 'read_user_cookie']);

Route::post('search_user_by_name', [EcommerceUsersController::class, 'search_user_by_name']);

Route::post('search_user_by_email', [EcommerceUsersController::class, 'search_user_by_email']);

Route::post('search_user_by_phone', [EcommerceUsersController::class, 'search_user_by_phone']);

Route::get('show_all_users' , [EcommerceUsersController::class , 'show_all_users']);
...
Route::get('show_all_product_orders', [EcommerceOrdersController::class, 'show_all_product_orders']);
