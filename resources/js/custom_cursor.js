export default class LightCursor {
    ...
    checkElementColor(e) {
        ...
        if (element) {
            ...
            }else if (this.hasQlEditorAncestor(element) || element.tagName === 'INPUT' || element.tagName === 'TEXTAREA' || element.tagName === 'SELECT' || textElements.includes(element.tagName) || textColor === '#020202' || textColor === '#ffffff') {
                this.isHoveringSpecialElement = true;
